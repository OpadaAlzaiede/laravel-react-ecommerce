...
export default function VendorDetails({ className }) {
    ...
    const becomeVendor = (ev) => {
        ...
        post(route('vendor.store'), {
            ...
            onSuccess: () => {
                closeModal();
                setSuccessMessage('Your account is now under review');
            },
            onError: (errors) => {
                console.log(errors);
            }
    ...
    return (
        <section className={className}>
            ...
            <header>
                <h2 className="flex justify-between mb-8 text-lg font-medium text-gray-900 dark:test-gray-100">
                    Vendor Details
            ...
            <div>
                {!user.vendor &&
                    <PrimaryButton onClick={ev => setShowBecomeVendorConfirmation(true)} disabled={processing}>
                        Become a vendor
                    </PrimaryButton>}
                {user.vendor && (
                    <>
