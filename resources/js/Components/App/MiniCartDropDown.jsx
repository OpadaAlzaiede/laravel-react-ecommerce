    ...
    return (
        <div className="dropdown dropdown-end">
            ...
            <div
                ...
                <div className={'my-4 max-h-[550px] overflow-auto'}>
                    ...
                    {miniCartItems.map((item) => (
                        <div key={item.id} className={'flex gap-4 p-3'}>
                            <Link href={productRoute(item)} className={'w-12 h-22 flex justify-center items-center'}>
                                <img src={item.image} alt={item.title} className={'max-w-full max-he-full'} />
                            </Link>
